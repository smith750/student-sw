...
/******/ 	var hotCurrentHash = "a2ff21f3a4a3810ff0cf"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _starship_tableJsx = __webpack_require__(171);
	...
	var _starship_infoJsx = __webpack_require__(217);

	var _starship_infoJsx2 = _interopRequireDefault(_starship_infoJsx);
	...
	var StarWarsRouter = _react2['default'].createClass({
	  displayName: 'StarWarsRouter',

	  render: function render() {
	    return _react2['default'].createElement(_reactRouter.Router, null, _react2['default'].createElement(_reactRouter.Route, { path: '/', component: StarWarsIndex }), _react2['default'].createElement(_reactRouter.Route, { path: 'starship', component: _starship_infoJsx2['default'] }));
	  }
	});

	var StarWarsIndex = _react2['default'].createClass({
	  displayName: 'StarWarsIndex',
	...
	_react2['default'].render(_react2['default'].createElement(StarWarsRouter, null), document.querySelector('.app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function xhrAdapter(resolve, reject, config) {
	  ...
	  if (utils.isStandardBrowserEnv()) {
	    ...
	    var urlIsSameOrigin = __webpack_require__(167);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _starships_utilsJs = __webpack_require__(216);

	var _reactRouter = __webpack_require__(174);

	var StarshipsTable = _react2['default'].createClass({
	    displayName: 'StarshipsTable',

	    render: function render() {
	        var starshipRows = this.props.starships.map(function (starship, idx) {
	            var key = "stsrship" + idx;
	            return _react2['default'].createElement(StarshipRow, { starship: starship, key: key });
	        });
	        return _react2['default'].createElement('table', null, _react2['default'].createElement(StarshipHeader, null), starshipRows);
	    }
	});

	var StarshipHeader = _react2['default'].createClass({
	    displayName: 'StarshipHeader',

	    render: function render() {
	        return _react2['default'].createElement('tr', null, _react2['default'].createElement('th', null, 'Name'), _react2['default'].createElement('th', null, 'Cost (in Credits)'), _react2['default'].createElement('th', null, 'Length'), _react2['default'].createElement('th', null, 'Crew Size'), _react2['default'].createElement('th', null, 'Passenger Size'), _react2['default'].createElement('th', null, 'Class'));
	    }
	});

	var StarshipRow = _react2['default'].createClass({
	    displayName: 'StarshipRow',
	    ...
	    render: function render() {
	        ...
	        return _react2['default'].createElement('tr', null, _react2['default'].createElement('td', null, this.props.starship.name), _react2['default'].createElement('td', null, (0, _starships_utilsJs.simpleFormat)(this.props.starship.cost_in_credits)), _react2['default'].createElement('td', null, (0, _starships_utilsJs.simpleFormat)(this.props.starship['length'])), _react2['default'].createElement('td', null, (0, _starships_utilsJs.simpleFormat)(this.props.starship.crew)), _react2['default'].createElement('td', null, (0, _starships_utilsJs.simpleFormat)(this.props.starship.passengers)), _react2['default'].createElement('td', null, this.props.starship.starship_class));
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StarshipInfo = _react2['default'].createClass({
	    displayName: 'StarshipInfo',

	    render: function render() {
	        return _react2['default'].createElement('div', null, _react2['default'].createElement('table', { className: 'starship' }, _react2['default'].createElement(StarshipInfoRow, { label: 'Name', info: this.props.params.starship.name }), _react2['default'].createElement(StarshipInfoRow, { label: 'Model', info: this.props.params.starship.model }), _react2['default'].createElement(StarshipInfoRow, { label: 'Manufacturer', info: this.props.params.starship.manufacturer }), _react2['default'].createElement(StarshipInfoRow, { label: 'Cost (in Credits)', info: (0, _starships_utilsJs.simpleFormat)(this.props.params.starship.cost_in_credits) }), _react2['default'].createElement(StarshipInfoRow, { label: 'Length', info: (0, _starships_utilsJs.simpleFormat)(this.props.params.starship['length']) }), _react2['default'].createElement(StarshipInfoRow, { label: 'Maximum Atmosphering Speed', info: (0, _starships_utilsJs.simpleFormat)(this.props.params.starship.max_atmosphering_speed) }), _react2['default'].createElement(StarshipInfoRow, { label: 'Crew', info: (0, _starships_utilsJs.simpleFormat)(this.props.params.starship.crew) }), _react2['default'].createElement(StarshipInfoRow, { label: 'Passengers', info: (0, _starships_utilsJs.simpleFormat)(this.props.params.starship.passengers) }), _react2['default'].createElement(StarshipInfoRow, { label: 'Cargo Capacity', info: this.props.params.starship.cargo_capacity }), _react2['default'].createElement(StarshipInfoRow, { label: 'Consumables', info: this.props.params.starship.consumables }), _react2['default'].createElement(StarshipInfoRow, { label: 'Hyperdrive Rating', info: this.props.params.starship.hyperdrive_rating }), _react2['default'].createElement(StarshipInfoRow, { label: 'MGLT', info: this.props.params.starship.MGLT }), _react2['default'].createElement(StarshipInfoRow, { label: 'Starship Class', info: this.props.params.starship.starship_class }), _react2['default'].createElement(StarshipInfoRow, { label: 'Pilots', info: this.props.params.starship.pilots.map(function (pilot) {
	                return pilot.name;
	            }).join(',') })), _react2['default'].createElement('div', null, _react2['default'].createElement(_reactRouter.Link, { to: '/' }, 'Back')));
	    }
	});

	var StarshipInfoRow = _react2['default'].createClass({
	    displayName: 'StarshipInfoRow',

	    render: function render() {
	        return _react2['default'].createElement('tr', null, _react2['default'].createElement('td', { className: 'label' }, this.props.label), _react2['default'].createElement('td', { className: 'info' }, this.props.info));
	    }
	});

	exports['default'] = StarshipInfo;
	module.exports = exports['default'];
